...
import 'riverpod/app_state.dart';
import 'riverpod/budget.dart';
...
class HomePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final budgets =
        ref.watch(budgetsProvider); // Menggunakan provider untuk budgets
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          _buildTransactionsList(context, budgets, ref),
        ],
      ),
        ...
        (context, index) {
          ...
          return Dismissible(
            ...
            onDismissed: (direction) {
              ref.read(budgetsProvider.notifier).removeBudget(budget);
